...
## Baseline Snapshot
| Metric | Baseline (2026-03-01 pre-fix) | Latest Release Truth (2026-03-01 23:05 UTC) | Target | Status |
|---|---:|---:|---|---|
| Multimode overall pass | 95.65% | 98.26% (`qa_round11_blackbox_fresh_20260301_230422`) | >=98% | PASS |
| Release-tier gate | N/A | PASS (`v2_qa_truth_report_20260301_224543`) | PASS | CLOSED |
| Follow-up continuity | 66.67% | 100.0% (`Q2`) | >=98% | CLOSED |
| Business semantic probes | 90.0% | 100.0% (`Q3`) | >=98% | CLOSED |
| Factual correctness | 100% | 100.0% (`Q1`) | >=99% | PASS |
| Safety/refusal | 100% | 100.0% (`Q5`) | 100% | PASS |
| Warning hygiene | 3.69 to 14.2 avg | 0.6269 actionable / 1.15 raw (`Q8`) | <=1.0 avg non-actionable | CLOSED |
| Latency p95 | ~24,982 ms | 95.64 ms (`Q7` max p95 across measured modes) | <=12,000 cloud; <=8,000 deterministic/auto | PASS |
...
| G03 | SkillContract warning noise dominates output | Diagnostic trust degradation | Actionable-warning taxonomy + per-run dedupe + warning tracking | <=1.0 avg non-actionable warnings/case | CLOSED |
...
| G06 | High p95 latency | Analyst workflow friction | Stage timings + stage SLO endpoint + provider-aware QA scheduling | Q7 SLO gates pass across merge/release modes | CLOSED (release-certified) |
...
| G12 | Release QA runner instability under multimode startup | False-negative gate failures | Tiered timeout controls + startup-health hardening + heavy-cloud parallel policy | Stable release-tier multimode pass with artifact | CLOSED (release-certified) |
...
- `/Users/moenuddeenahmadshaik/Desktop/dataAssistantGenAI/haikugraph/reports/v2_qa_truth_report_20260301_224543.json`
- `/Users/moenuddeenahmadshaik/Desktop/dataAssistantGenAI/haikugraph/reports/qa_round11_blackbox_fresh_20260301_230422.json`
